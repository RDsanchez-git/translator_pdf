...
| `main_corpus` (verbos admit/draft/canonicalize/curate/seal/regress) | Orquestador delgado de onboarding/evaluación | **Batch 2 (pendiente)**; no es entry point existente |
