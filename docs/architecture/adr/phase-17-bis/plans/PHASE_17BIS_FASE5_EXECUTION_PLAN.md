...
| GF-03 | Governance Finding: el onboarding v2.2 selló doc_09/doc_10 sin evidencia de curaduría previa y sobre corpus heterogéneo. Corrección forense incluida: claim de identidad duplicada descartado por SHA-256; tautología corregida a 3/9. | Findings Register §11 (Governance Finding) |
| H-5.5-2 | doc_09_vanhaverbeke y doc_10_gross sellados sin curaduría previa (NADR-21 §5.1 R5); NSS=1.0 tautológico. | Findings Register §3.3 (ACCEPTED_LIMITATION; sustitución diferida a v3.0) |
| H-5.5-3 | Directorios legacy (calibration_v1/, benchmark_v1/) coexisten con el corpus canónico; riesgo operacional de mutación espuria (precedente H-5.4-2). | Findings Register §3.3 (ACCEPTED_LIMITATION operacional; mitigado por --corpus-dir explícito, GAP-5.0-03) |
| H-5.5-4 | Heterogeneidad de baseline: GTs de doc_01–05 generados con configuración de extracción legacy (nodos table/equation/caption no reproducibles por el pipeline vigente); HARD_FAIL estructural en 5/9 documentos en la regresión v2.2. | Findings Register §3.3 (ACCEPTED_LIMITATION; re-baseline v3.0) |

*Nota: GF-03 y H-5.5-2/3/4 fueron identificados el 2026-09-14 durante la revisión del onboarding v2.2 y su regresión, con Gate 1 en IN_PROGRESS; se registran aquí por ser la Wave cuyo alcance normativo (NADR-21 §5.1, §5.8) gobierna los hechos observados.*
...
- Elegibilidad de curaduría: cada oráculo sellado posee evidencia de curaduría en FASE_5_WAVE_1_3_CURATION_REPORT.md (o addendum), o está explícitamente registrado como no-informativo/tautológico con sustitución programada en el Findings Register (NADR-21 §5.1 R5; GF-03 Opción A).
- Homogeneidad de baseline o interpretación documentada: los HARD_FAIL de regresión atribuibles a heterogeneidad de baseline (H-5.5-4) están resueltos por re-baseline (v3.0+) o explícitamente aceptados con política de interpretación publicada en el Findings Register antes de FINAL EVALUATION (NADR-23 §5.4 R14-R16).
- Pyright: 0 errors, 0 warnings.
